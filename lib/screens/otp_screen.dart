  ...
  void _submit(
    ...
    if (otpResponse['type'] == 'not-exist' &&
      ...
      Map<String, dynamic> decodedToken =
          JwtDecoder.decode(localStorage.getString('token')!);

      localStorage.setString('roleOfUser', decodedToken['userRole']);

      bool value =
          localStorage.getString('roleOfUser') == 'provider' ? true : false;

      localStorage.setBool('boolValue', value);

      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text(
            '${response['message']} ${localStorage.getString('roleOfUser')} ${localStorage.getBool('boolValue')}',
